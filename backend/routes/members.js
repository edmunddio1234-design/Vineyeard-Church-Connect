...
router.get('/', auth, async (req, res) => {
  try {
    ...
    let query = 'SELECT id, name, email, avatar, profile_image, phone, location, work, age, has_kids, is_retired, marital_status, birthday, languages, can_drive, dietary, spiritual_gifts, current_groups, desired_groups, hobbies, available, need_help_with, is_business_owner, business_name, business_description, on_prayer_team, bio, social, joined FROM users WHERE id != $1';
