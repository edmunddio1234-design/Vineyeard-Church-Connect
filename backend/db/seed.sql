...
('Sarah Johnson', 'sarah.johnson@example.com', '$2a$10$YourHashedPasswordHere1', '👩', 'Zachary', 'Elementary School Teacher', 38, 3, 'Married', 'Passionate about education and community', '225-555-0001', 'Vegetarian', '{English}', '{Reading,Gardening,Volunteering}', '{Teaching,Encouragement}', '{Kids Ministry,Women Group}', '{Bible Study,Prayer Group}', '{Monday,Wednesday,Saturday}', '2024'),
('Marcus Williams', 'marcus.williams@example.com', '$2a$10$YourHashedPasswordHere2', '👨', 'Baton Rouge Mid City', 'Software Engineer at CGI Federal', 29, 0, 'Single', 'Tech enthusiast passionate about serving the community', '225-555-0002', 'Omnivore', '{English,Spanish}', '{Coding,Sports,Gaming}', '{Leadership,Innovation}', '{Tech Ministry,Young Adults}', '{Outreach,Mission Work}', '{Tuesday,Thursday,Sunday}', '2023'),
('Emily Chen', 'emily.chen@example.com', '$2a$10$YourHashedPasswordHere3', '👩', 'Baton Rouge Southdowns', 'Registered Nurse', 34, 1, 'Married', 'Healthcare professional dedicated to caring for others', '225-555-0003', 'Gluten-free', '{English,Mandarin}', '{Cooking,Yoga,Hiking}', '{Compassion,Healing}', '{Healthcare Ministry,Young Families}', '{Community Service,Discipleship}', '{Wednesday,Friday,Saturday}', '2024'),
('David Martinez', 'david.martinez@example.com', '$2a$10$YourHashedPasswordHere4', '👨', 'Central', 'Contractor', 42, 2, 'Married', 'Skilled tradesman committed to building God''s kingdom', '225-555-0004', 'Omnivore', '{English,Spanish}', '{Construction,Sports,Music}', '{Service,Building}', '{Men Group,Family Ministry}', '{Worship,Service Opportunities}', '{Monday,Wednesday,Saturday,Sunday}', '2022'),
('Rachel Martinez', 'rachel.martinez@example.com', '$2a$10$YourHashedPasswordHere5', '👩', 'Central', 'Accountant', 40, 2, 'Married', 'Detail-oriented professional serving the family', '225-555-0005', 'Omnivore', '{English,Spanish}', '{Music,Family Activities,Volunteering}', '{Administration,Organization}', '{Women Group,Family Ministry}', '{Worship,Community Service}', '{Tuesday,Thursday,Saturday,Sunday}', '2022'),
('Grace Thompson', 'grace.thompson@example.com', '$2a$10$YourHashedPasswordHere6', '👵', 'Baton Rouge Broadmoor', 'Retired School Principal', 67, 4, 'Widowed', 'Retired educator passionate about mentoring youth', '225-555-0006', 'Omnivore', '{English}', '{Reading,Mentoring,Crafts}', '{Wisdom,Mentorship}', '{Senior Fellowship,Prayer Group}', '{Discipleship,Mentoring}', '{Monday,Wednesday,Thursday,Sunday}', '2020'),
('Jason Park', 'jason.park@example.com', '$2a$10$YourHashedPasswordHere7', '👨', 'Baton Rouge Sherwood Forest', 'Physical Therapist', 31, 0, 'Engaged', 'Healthcare professional focused on wellness and service', '225-555-0007', 'Omnivore', '{English,Korean}', '{Sports,Fitness,Outdoor Activities}', '{Healing,Encouragement}', '{Young Adults,Sports Ministry}', '{Mission Work,Community Outreach}', '{Tuesday,Thursday,Friday,Saturday}', '2023'),
('Lisa Okafor', 'lisa.okafor@example.com', '$2a$10$YourHashedPasswordHere8', '👩', 'Baton Rouge Garden District', 'Graphic Designer', 27, 0, 'Single', 'Creative professional using design to serve the community', '225-555-0008', 'Vegetarian', '{English,Yoruba}', '{Design,Art,Travel}', '{Creativity,Service}', '{Young Adults,Creative Arts Ministry}', '{Outreach,Community Service}', '{Wednesday,Friday,Saturday,Sunday}', '2024');
